...
impl PartialEq for StatusOid {
    fn eq(&self, other: &Self) -> bool {
        self.0 == other.0
    }
}

impl Eq for StatusOid {}

impl Deref for StatusOid {
    type Target = String;
...
// SQLx record type
impl From<String> for StatusOid {
    fn from(value: String) -> Self {
        Self(value)
    }
}
#[async_trait]
impl DataValidator for StatusOid {
